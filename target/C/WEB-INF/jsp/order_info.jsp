	...
	<body>
		...
		<div class="container">
							...
							<c:forEach items="${order.items }" var="item">
								<tr class="active">
									<td width="60" width="40%">
										...
										<img src="${pageContext.request.contextPath}/pic/${item.product.pimage}" width="70" height="60">
									</td>
									<td width="30%">
			...
			<div>
				...
				<form id="orderForm" action="${pageContext.request.contextPath }/order/orderForm.action" method="post" class="form-horizontal" style="margin-top:5px;margin-left:150px;">
