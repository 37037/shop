			...
			<div style="text-align: center;">
						<ul class="pagination">
							<c:if test="${page.curPage != 1 }">
								<li><a href="${pageContext.request.contextPath }/admin/listOrder.action?curPage=${page.curPage - 1}&state=${param.state}" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>
							</c:if>
							...
							<c:forEach begin="1" end="${page.totalPage }" var="i">
								...
								<c:if test="${page.curPage != i }">
									<li><a href="${pageContext.request.contextPath }/admin/listOrder.action?curPage=${i}&state=${param.state}">${i }</a></li>
								</c:if>
							</c:forEach>
							<c:if test="${page.curPage != page.totalPage }">
								<li>
									<a href="${pageContext.request.contextPath }/admin/listOrder.action?curPage=${page.curPage + 1}&state=${param.state}" aria-label="Next">
